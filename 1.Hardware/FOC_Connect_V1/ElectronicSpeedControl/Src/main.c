...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : M1_CURR_SHUNT_U_Pin M1_OPAMP1_OUT_Pin M1_OPAMP1_INT_GAIN_Pin M1_OPAMP2_INT_GAIN_Pin
                           M1_OPAMP2_OUT_Pin M1_CURR_SHUNT_V_Pin */
  GPIO_InitStruct.Pin = M1_CURR_SHUNT_U_Pin|M1_OPAMP1_OUT_Pin|M1_OPAMP1_INT_GAIN_Pin|M1_OPAMP2_INT_GAIN_Pin
                          |M1_OPAMP2_OUT_Pin|M1_CURR_SHUNT_V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : M1_CURR_SHUNT_W_Pin M1_OPAMP3_OUT_Pin M1_OPAMP3_INT_GAIN_Pin */
