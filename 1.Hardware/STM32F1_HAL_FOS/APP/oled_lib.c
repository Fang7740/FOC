...
//偏移量32
//大小:12*6
const unsigned char oled_asc2_0806[][6] =
	{
...
const unsigned char oled_CH_1616[][12] = {
	//酷(0) 世(1) 多(2) 功(3) 能(4) 下(5) 载(6) 器(7)

	{0x5F, 0xF0, 0x52, 0xA0, 0x7C, 0xA0, 0x52, 0xA0, 0x5F, 0xF0, 0x14, 0x00},
	{0x65, 0xF0, 0x25, 0x20, 0xFD, 0x20, 0x25, 0x20, 0x25, 0xF0, 0x00, 0x00}, /*"酷",0*/

	{0x08, 0x00, 0x08, 0x00, 0x7F, 0xF0, 0x08, 0x10, 0x08, 0x10, 0xFF, 0x90},
	{0x08, 0x90, 0x08, 0x90, 0xFF, 0x90, 0x08, 0x10, 0x08, 0x10, 0x00, 0x00}, /*"世",1*/

	{0x09, 0x10, 0x09, 0x10, 0x12, 0x10, 0x2A, 0x90, 0xC4, 0xA0, 0x49, 0x20},
	{0x52, 0xC0, 0x66, 0x40, 0x4A, 0x80, 0x03, 0x00, 0x02, 0x00, 0x00, 0x00}, /*"多",2*/

	{0x20, 0x40, 0x20, 0x40, 0x3F, 0x80, 0x20, 0x90, 0x20, 0xA0, 0x10, 0xC0},
	{0xFF, 0x00, 0x10, 0x00, 0x10, 0x10, 0x10, 0x10, 0x1F, 0xE0, 0x00, 0x00}, /*"功",3*/

	{0x20, 0x00, 0x6F, 0xF0, 0xAA, 0x80, 0x2A, 0x90, 0x6F, 0xF0, 0x00, 0x00},
	{0xF3, 0xE0, 0x28, 0x50, 0x48, 0x90, 0x89, 0x10, 0x18, 0x70, 0x00, 0x00}, /*"能",4*/

	{0x40, 0x00, 0x40, 0x00, 0x40, 0x00, 0x40, 0x00, 0x7F, 0xF0, 0x40, 0x00},
	{0x48, 0x00, 0x44, 0x00, 0x42, 0x00, 0x41, 0x80, 0x40, 0x00, 0x00, 0x00}, /*"下",5*/

	{0x14, 0x20, 0x57, 0x20, 0x5D, 0x20, 0xF7, 0xF0, 0x55, 0x40, 0x55, 0x40},
	{0x10, 0x10, 0xFF, 0x20, 0x10, 0xC0, 0x97, 0x20, 0x50, 0x70, 0x00, 0x00}, /*"载",6*/

	{0x04, 0x80, 0xE4, 0xF0, 0xA5, 0x50, 0xA5, 0x50, 0xE6, 0x70, 0x1C, 0x00},
	{0xE6, 0x70, 0xA5, 0x50, 0xB5, 0x50, 0xEC, 0xF0, 0x04, 0x80, 0x00, 0x00}, /*"器",7*/
...
const unsigned char oled_CH0[][12] = {
	//有(0) 线(1) 仿(2) 真(3) 模(4) 式(5)

	{0x22, 0x00, 0x24, 0x00, 0x2F, 0xF0, 0x3A, 0x80, 0xEA, 0x80, 0x2A, 0x80},
	{0x2A, 0x80, 0x2A, 0x80, 0x2A, 0x90, 0x2F, 0xF0, 0x20, 0x00, 0x00, 0x00}, /*"有",0*/

	{0x19, 0x20, 0x2B, 0x20, 0xCD, 0x40, 0x11, 0x40, 0x00, 0x10, 0x12, 0x10},
	{0x12, 0x20, 0xFF, 0xC0, 0x24, 0xA0, 0xA5, 0x10, 0x64, 0x70, 0x00, 0x00}, /*"线",1*/

	{0x04, 0x00, 0x08, 0x00, 0x3F, 0xF0, 0xC0, 0x00, 0x20, 0x10, 0x20, 0x60},
	{0xBF, 0x80, 0x64, 0x00, 0x24, 0x10, 0x24, 0x10, 0x27, 0xE0, 0x00, 0x00}, /*"仿",2*/

	{0x00, 0x40, 0x40, 0x40, 0x5F, 0xD0, 0x55, 0x60, 0x55, 0x40, 0xF5, 0x40},
	{0x55, 0x40, 0x55, 0x60, 0x5F, 0xD0, 0x40, 0x40, 0x00, 0x40, 0x00, 0x00}, /*"真",3*/

	{0x11, 0x00, 0x16, 0x00, 0xFF, 0xF0, 0x12, 0x00, 0x40, 0x50, 0x5F, 0x50},
	{0xF5, 0x60, 0x55, 0xC0, 0xF5, 0x60, 0x5F, 0x50, 0x40, 0x50, 0x00, 0x00}, /*"模",4*/
...
const unsigned char oled_CH1[][12] = {
	//脱(0) 机(1) 烧(2) 录(3) 模(4) 式(5)

	{0x00, 0x10, 0x7F, 0xE0, 0x49, 0x10, 0x7F, 0xF0, 0x00, 0x10, 0x9E, 0x20},
	{0x53, 0xC0, 0x12, 0x00, 0x53, 0xE0, 0x9E, 0x10, 0x00, 0x30, 0x00, 0x00}, /*"脱",0*/

	{0x11, 0x00, 0x16, 0x00, 0xFF, 0xF0, 0x14, 0x10, 0x02, 0x20, 0x7F, 0xC0},
	{0x40, 0x00, 0x40, 0x00, 0x7F, 0xE0, 0x00, 0x10, 0x00, 0x70, 0x00, 0x00}, /*"机",1*/

	{0x1E, 0x10, 0x00, 0x60, 0xFF, 0x80, 0x10, 0x60, 0x21, 0x10, 0x25, 0x20},
	{0xF5, 0xC0, 0x49, 0x00, 0x55, 0xE0, 0x45, 0x10, 0x1D, 0x30, 0x00, 0x00}, /*"烧",2*/

	{0x08, 0x20, 0x8A, 0x20, 0xA9, 0x40, 0xA8, 0x80, 0xA9, 0x10, 0xAF, 0xF0},
	{0xA9, 0x00, 0xA8, 0x80, 0xF9, 0x40, 0x0A, 0x20, 0x08, 0x20, 0x00, 0x00}, /*"录",3*/
...
const unsigned char oled_CH2[][12] = {
	//无(0) 线(1) 仿(2) 真(3) 模(4) 式(5)

	{0x04, 0x10, 0x44, 0x20, 0x44, 0x40, 0x44, 0x80, 0x47, 0x00, 0x7C, 0x00},
	{0x47, 0xE0, 0x44, 0x10, 0x44, 0x10, 0x44, 0x10, 0x04, 0x70, 0x00, 0x00}, /*"无",0*/
...
const unsigned char oled_CH4[][12] = {
	...
	{0x00, 0x00, 0x08, 0x00, 0x88, 0x00, 0x4F, 0xE0, 0x00, 0x40, 0x0A, 0x10},
	{0xF3, 0x10, 0x82, 0xA0, 0x82, 0x40, 0xF2, 0xA0, 0x0B, 0x10, 0x08, 0x10}, /*"设",0*/

	{0x00, 0x00, 0x08, 0x10, 0xE8, 0x10, 0xAB, 0xF0, 0xAA, 0x10, 0xEA, 0x10},
	{0xBE, 0x70, 0xEA, 0x10, 0xAA, 0x10, 0xAB, 0xF0, 0xE8, 0x10, 0x08, 0x10}, /*"置",1*/

	{0x00, 0x00, 0x00, 0x10, 0x3F, 0xE0, 0x24, 0x00, 0x24, 0x40, 0x27, 0xD0},
	{0x20, 0x20, 0xFF, 0x40, 0x20, 0x80, 0xA1, 0x40, 0x66, 0x20, 0x20, 0xF0}, /*"成",2*/

	{0x00, 0x00, 0x20, 0x40, 0x20, 0x40, 0x3F, 0x80, 0x20, 0x90, 0x20, 0xA0},
	{0x10, 0xC0, 0xFF, 0x00, 0x10, 0x00, 0x10, 0x10, 0x10, 0x10, 0x1F, 0xE0}, /*"功",3*/

	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7C, 0xC0, 0x7C, 0xC0, 0x00, 0x00},
...
const unsigned char oled_CH5[][12] = {
	...
	{0x00, 0x00, 0x1E, 0x10, 0x00, 0x60, 0xFF, 0x80, 0x10, 0x60, 0x21, 0x10},
	{0x25, 0x20, 0xF5, 0xC0, 0x49, 0x00, 0x55, 0xE0, 0x45, 0x10, 0x1D, 0x30}, /*"烧",0*/

	{0x00, 0x00, 0x08, 0x20, 0x8A, 0x20, 0xA9, 0x40, 0xA8, 0x80, 0xA9, 0x10},
	{0xAF, 0xF0, 0xA9, 0x00, 0xA8, 0x80, 0xF9, 0x40, 0x0A, 0x20, 0x08, 0x20}, /*"录",1*/
...
const unsigned char oled_CH6[][12] = {
	...
	{0x70, 0x20, 0x10, 0x40, 0x11, 0x90, 0x1E, 0x10, 0xF3, 0x20, 0x12, 0xA0},
	{0x12, 0x40, 0x92, 0xA0, 0x53, 0x20, 0x10, 0x10, 0x10, 0x10, 0x00, 0x00}, /*"发",2*/

	{0x01, 0x20, 0x7F, 0x40, 0xD5, 0x80, 0x55, 0x10, 0x7F, 0xF0, 0x00, 0x00},
	{0x12, 0x00, 0x11, 0x90, 0x10, 0x10, 0xFF, 0xF0, 0x10, 0x00, 0x00, 0x00}, /*"射",3*/

	{0x97, 0x20, 0x50, 0xA0, 0x17, 0x40, 0x00, 0x00, 0x75, 0xF0, 0x15, 0x00},
	{0x15, 0xE0, 0xF7, 0x00, 0x15, 0xE0, 0x15, 0x10, 0x75, 0xF0, 0x00, 0x00}, /*"端",4*/
...
const unsigned char oled_CH7[][12] = {
	...
	{0x11, 0x00, 0x11, 0x10, 0xFF, 0xF0, 0x12, 0x00, 0x25, 0x10, 0x35, 0x50},
	{0xAD, 0xD0, 0x67, 0x20, 0x2D, 0x20, 0x35, 0xD0, 0x25, 0x10, 0x00, 0x00}, /*"接",2*/

	{0x7F, 0xC0, 0x00, 0x80, 0x01, 0x00, 0xFF, 0xF0, 0x04, 0x10, 0x08, 0x20},
	{0xF7, 0x40, 0x10, 0x80, 0x11, 0x40, 0x1E, 0x20, 0x10, 0x10, 0x00, 0x00}, /*"收",3*/
